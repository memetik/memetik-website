    ...
    <section className="relative min-h-screen w-full flex flex-col justify-center overflow-hidden bg-background text-foreground">
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12 pt-24 pb-12">
        ...
        <motion.p
          ...
          className="text-base text-foreground/60 max-w-3xl mb-10"
        >
        ...
        >
          Series A-B+ SaaS · E-commerce · Professional Services
        </motion.p>
      </div>
    </section>
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group relative flex flex-col min-h-[460px] p-6 md:p-8 bg-background border border-foreground/10 rounded"
            >
              ...
              <div className="border border-foreground/10 rounded p-4 mb-6 bg-muted">
                <div className="font-mono text-[10px] uppercase tracking-widest text-foreground/50 mb-1">
                  What You Get
                </div>
              ...
              <div className="flex flex-wrap items-center gap-2 mt-auto">
                {item.tags.map((tag) => (
                  <div
                    key={tag}
                    className="border border-foreground/15 rounded px-3 py-1.5 font-mono text-[10px] uppercase tracking-wider"
                  >
                    {tag}
                  </div>
                ))}
            ...
            >
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3 text-foreground/40 line-through text-sm">
                    <X className="w-3 h-3" />
                    {item}
                  </li>
                ))}
            ...
            >
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3 text-background text-sm font-semibold">
...
function TestTwoMethodology() {
  return (
    <section
      id="methodology"
      className="py-24 md:py-32 bg-background text-foreground px-4 md:px-0 border-b border-foreground/10 relative overflow-hidden"
    >
          ...
          >
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex justify-between items-start mb-8">
                ...
                <div className="text-foreground/20">{phase.icon}</div>
              </div>
              ...
              <div className="mt-auto relative z-10">
                <div className="mb-6 border-l-2 border-accent pl-6">
                  <p className="font-sans text-lg text-foreground leading-tight">{phase.description}</p>
                </div>
                <div className="bg-muted border border-foreground/10 rounded p-3 mb-6">
                  <p className="font-mono text-xs text-foreground/60 uppercase mb-1">
                    Expected Outcome
                  </p>
...
function TestTwoQualification() {
  return (
    <section
      id="who-we-serve"
      className="py-16 md:py-24 px-4 sm:px-6 md:px-12 border-b border-foreground/10 bg-background text-foreground"
    >
      <div className="max-w-6xl mx-auto">
        <div className="inline-flex items-center gap-2 border border-foreground/15 px-3 py-1.5 rounded-full mb-6">
          <span className="font-mono text-xs uppercase tracking-wider text-foreground/70">
        ...
        <div className="border-t border-foreground/10 pt-8 mb-12">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <div key={item} className="border border-foreground/15 px-4 py-2 rounded text-sm">
                {item}
              </div>
            ))}
          </div>
            ...
            >
              ...
              <AnimatePresence initial={false}>
                {openIndex === i && (
                  ...
                  >
                    <div className="pb-6">
                      <p className="text-base text-foreground/70 leading-relaxed max-w-3xl">{faq.answer}</p>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-foreground/15">
              <div className="flex items-center gap-4 mb-4 md:mb-0">
                <h3 className="text-xl font-display font-bold tracking-tight">MEMETIK</h3>
                <span className="font-mono text-xs text-foreground/40">Revenue-First SEO + GEO</span>
              </div>
